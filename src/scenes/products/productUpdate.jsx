...
const ProductUpdate = () => {
    ...
    const [initialValuesUpdate, setInitialValuesUpdate] = React.useState({});
    ...
    React.useEffect(() => {
        const fetchProduct = async (product) => {
            try {
                ...
                setInitialValuesUpdate(productData);
            } catch (error) {
    ...
    const handleFormUpdate = async (values, onSubmitProps, updatedProduct) => {
